...
let SocialMedia = (props) =>(
    <div className="d-flex">
      <a><svg xmlns="http://www.w3.org/2000/svg" aria-label="twitter" role="image" focusable="false" enableBackground="new 0 0 28 22.934" viewBox="0 0 28 22.934" id="twitter-logo" className={` ml5 ${props.className}`}>
      ...
      <a><svg xmlns="http://www.w3.org/2000/svg" aria-label="github" role="image" focusable="false" enableBackground="new 0 0 28 27.311" viewBox="0 0 28 27.311" id="github-logo" className={`ml5 ${props.className}`}>
      ...
      <a> <svg xmlns="http://www.w3.org/2000/svg" aria-label="slack" role="image" focusable="false" viewBox="0 0 44.26 44.26" id="slack" className={`ml5 ${props.className}`}>
      <g>
